...
# colors
background_color = (96, 184, 206)

# initializing pygame, setting up the surface (canvas)
pygame.init()
canvas = pygame.display.set_mode((width, height))
pygame.display.set_caption("Apple Tree") # add a caption for your canvas

# import assets
sprite_sheet = pygame.image.load("Apple_Tree.png").convert_alpha() # add the path/name of your sprite sheet file

# get details about individual sprites
total_sprites = 10 # code the number of sprite images your sprite sheet has
